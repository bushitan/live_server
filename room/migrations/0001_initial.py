    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=100, null=True, verbose_name='IM\u623f\u95f4\u53f7', blank=True)),
                ('style', models.IntegerField(default=0, verbose_name='\u7c7b\u578b', choices=[(0, '\u6587\u5b57'), (1, '\u56fe\u7247'), (2, '\u8bed\u97f3')])),
                ('text', models.CharField(max_length=400, null=True, verbose_name='IM\u623f\u95f4\u53f7', blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pusher_url', models.CharField(max_length=500, null=True, verbose_name='\u63a8\u6d41\u5730\u5740', blank=True)),
                ('player_url', models.CharField(max_length=500, null=True, verbose_name='\u64ad\u653e\u5730\u5740', blank=True)),
